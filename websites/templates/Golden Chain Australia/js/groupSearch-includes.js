...
jQuery.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyB9yaIoZlsvDLL66hCTO6BFA82tQMSeObc&libraries=places,geometry',function (){
	jQuery.getScript('https://book.goldenchain.com.au/js/groupSearch.js', function (){
	});		
});		
...
loadCSS('https://book.goldenchain.com.au/css/embed-search-wide.css');
loadCSS('https://book.goldenchain.com.au/css/daterangepicker.css');
